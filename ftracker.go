...
func RunningSpentCalories(action int, weight, duration float64) float64 {
	// ваш код здесь
	middleSpeed := meanSpeed(action, duration)
	return (runningCaloriesMeanSpeedMultiplier * middleSpeed * runningCaloriesMeanSpeedShift) * weight / mInKm * duration * minInH
}
...
func WalkingSpentCalories(action int, duration, weight, height float64) float64 {
	// ваш код здесь
	middleSpeed := meanSpeed(action, duration)
	return (walkingCaloriesWeightMultiplier*weight + (math.Pow(middleSpeed, 2)/height)*walkingSpeedHeightMultiplier*weight) * duration * minInH
}
...
func SwimmingSpentCalories(lengthPool, countPool int, duration, weight float64) float64 {
	// ваш код здесь
	middleSpeed := swimmingMeanSpeed(lengthPool, countPool, duration)
	return (middleSpeed + swimmingCaloriesMeanSpeedShift) * swimmingCaloriesWeightMultiplier * weight * (duration * minInH)
